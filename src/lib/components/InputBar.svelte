...
<div class="relative z-20 border-t border-gray-300 bg-white p-4">
  ...
  <div class="flex items-center gap-2">
    ...
    <button
      ...
      class="rounded border px-2 py-2 text-sm transition-colors {webSearchEnabled ? 'border-blue-500 bg-blue-500 text-white hover:bg-blue-600' : 'border-gray-300 bg-white text-gray-500 hover:bg-gray-50'}"
      title="Web Search"
    ...
    <button
      ...
      class="rounded border px-2 py-2 text-sm transition-colors {selectedModel.provider === 'google' ? 'border-blue-300 bg-blue-300 text-white' : reasoningEnabled ? 'border-blue-500 bg-blue-500 text-white hover:bg-blue-600' : 'border-gray-300 bg-white text-gray-500 hover:bg-gray-50'}"

...
* [ ] A static site, therefore trivial to host
* [ ] Works well on mobile (don't even care if it's usable on bigger screens)
* [ ] GPT-5, Claude, and Gemini
* [ ] API keys set client-side
* [ ] Chats stored client-side
